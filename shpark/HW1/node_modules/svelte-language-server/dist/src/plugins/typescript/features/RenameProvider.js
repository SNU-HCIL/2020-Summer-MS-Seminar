...
class RenameProviderImpl {
    ...
    async rename(document, position, newName) {
        ...
        let convertedRenameLocations = await this.mapRenameLocationsToParent(renameLocations, docs);
     ...
     */
    async mapRenameLocationsToParent(renameLocations, fragments) {
        return Promise.all(renameLocations.map(async (loc) => {
