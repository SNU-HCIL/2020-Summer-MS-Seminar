...
export declare class SvelteDocumentSnapshot implements DocumentSnapshot {
    ...
    private _scriptKind?;
    version: number;
    constructor(parent: Document, parserError: ParserError | null, text: string, nrPrependedLines: number, tsxMap?: RawSourceMap | undefined);
    get filePath(): string;
    get scriptKind(): ts.ScriptKind.JS | ts.ScriptKind.JSX | ts.ScriptKind.TS | ts.ScriptKind.TSX | ts.ScriptKind.External | ts.ScriptKind.JSON | ts.ScriptKind.Deferred;
