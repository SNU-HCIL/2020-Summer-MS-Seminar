...
class UpdateImportsProviderImpl {
    ...
    async updateImports(fileRename) {
        ...
        const documentChanges = await Promise.all(updateImportsChanges.map(async (change) => {
            ...
            return vscode_languageserver_1.TextDocumentEdit.create(vscode_languageserver_1.VersionedTextDocumentIdentifier.create(fragment.getURL(), null), change.textChanges.map((edit) => {
