...
(function (factory) {
    ...
    var MixinContent = /** @class */ (function (_super) {
        __extends(MixinContent, _super);
        function MixinContent(offset, length) {
            return _super.call(this, offset, length) || this;
        }
        Object.defineProperty(MixinContent.prototype, "type", {
            get: function () {
        ...
        MixinContent.prototype.getArguments = function () {
            if (!this.arguments) {
                this.arguments = new Nodelist(this);
            }
            return this.arguments;
    ...
    exports.MixinContent = MixinContent;
    var MixinReference = /** @class */ (function (_super) {
        ...
        MixinReference.prototype.getContentArguments = function () {
